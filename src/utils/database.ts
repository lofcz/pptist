...
// Remove stale/expired IndexedDB databases.
// On app close (tab close or refresh), the active database id is stored in localStorage as discarded.
// On init, scan all databases and delete any id listed as discarded.
// Also delete databases older than 12 hours from their creation timestamp (safety net for missed cleanup).
